...
const deleteObj = (obj, keys) => keys.reduce((o, k) => {
    const { [k]: _ , ...r } = o;
    return r;
}, obj);
...
const handleData = (data) => {
  ...
  let
    totalLength = calTotalLength(data,keys),
    firstDataLength = firstDataKeys.includes('거주인원수') ? 1 : firstKey === "요리" && firstDataKeys.includes('계산') ? firstDataKeys.length - 1 : firstDataKeys.length;
