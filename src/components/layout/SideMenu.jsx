...
export default function SideMenu(props) {
  ...
  return(
    <div className={sideWide || sideShow? "side_menu wide" : "side_menu"} onMouseOver={()=>setSideWide(true)} onMouseLeave={()=>setSideWide(false)}>
      <div className="inner">
        <Link to="/" className="logo" onClick={sideClose}><img src={logoImg} alt="" /></Link>
        <div className="side_menu_list">
          <div className="btn_wrap user active">
            ...
            <ul className="sub_menu_list">
              <li className="list active" onClick={sideClose}><Link to="/UserList">회원 리스트</Link></li>
              <li className="list"><Link to="">탈퇴/삭제 회원</Link></li>
            </ul>
          </div>
          <div className="btn_wrap event">
            ...
            <ul className="sub_menu_list">
              <li className="list"><Link to="">데일리 챌린지 관리</Link></li>
              <li className="list"><Link to="">탄소 중립 랭킹 관리</Link></li>
              <li className="list"><Link to="">공개 배너 순위 관리</Link></li>
              <li className="list"><Link to="">배너 관리</Link></li>
              <li className="list"><Link to="">팝업 관리</Link></li>
            </ul>
          </div>
          ...
          <div className="btn_wrap point">
            ...
            <ul className="sub_menu_list">
              <li className="list"><Link to="">도장 관리</Link></li>
              <li className="list"><Link to="">포인트 관리</Link></li>
            </ul> 
          </div>
          <div className="btn_wrap board">
            ...
            <ul className="sub_menu_list">
              <li className="list"><Link to="">이벤트/뉴스관리</Link></li>
              <li className="list"><Link to="">탄소중립TIP 자료실 관리</Link></li>
              <li className="list"><Link to="">FAQ 관리</Link></li>
              <li className="list"><Link to="">1:1문의 관리</Link></li>
            </ul> 
          </div>
          <div className="btn_wrap device">
            ...
            <ul className="sub_menu_list">
              <li className="list"><Link to="">기기 목록 관리</Link></li>
              <li className="list"><Link to="">GL 추천제품 관리</Link></li>
            </ul> 
          </div>
        </div>
      </div>
